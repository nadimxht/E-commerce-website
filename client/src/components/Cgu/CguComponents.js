...
export function Header() {
  return (
    <div className="container-fluid">
      <div className="row">
        <h1 className="col-lg-12 cguHeaderSize pt-5 pb-5">
          Conditions générales d'utilisation de E-Corp
        </h1>
      </div>
    </div>
  );
...
export function Art1() {
  return (
    <div>
      <h4 className="cguArticles mb-4">ARTICLE 1 : Objet </h4>

      <p>
        Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique
        des modalités de mise à disposition des services de <strong>E-Corp</strong> et leur
        utilisation par « l'Utilisateur ». Les conditions générales d'utilisation doivent être
        acceptées par tout Utilisateur souhaitant accéder au site. Elles constituent le contrat
        entre le site et l'Utilisateur. L’accès au site par l’Utilisateur signifie son acceptation
        des présentes conditions générales d’utilisation. Éventuellement :
      </p>

      <ol>
        <li>
          En cas de non-acceptation des conditions générales d'utilisation stipulées dans le présent
          contrat, l'Utilisateur se doit de renoncer à l'accès des services proposés par le site.
        </li>
        <li>
          <strong>E-Corp</strong> se réserve le droit de modifier unilatéralement et à tout moment
...
export function Art2() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 2 : Mentions légales</h1>
      <p>
        L'édition du site <strong>E-Corp</strong> est assurée par la Société [Nom de la société]
        [SAS / SA / SARL, etc.] au capital de [montant en euros] € dont le siège social est situé au
        [adresse du siège social]. [Le Directeur / La Directrice] de la publication est [Madame /
        Monsieur] [Nom &amp; Prénom]. Éventuellement :
      </p>
      <ol>
        <li>
          [Nom de la société] est une société du groupe [Nom de la société] [SAS / SA / SARL, etc.]
          au capital de [montant en euros] € dont le siège social est situé au [adresse du siège
          social].
        </li>
      </ol>
      <p>
        L'hébergeur du site [Nom du site] est la Société [Nom de la société] [SAS / SA / SARL, etc.]
        au capital de [montant en euros] € dont le siège social est situé au [adresse du siège
        social].
      </p>
      <hr className="mt-4 mb-4" />
...
export function Art3() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 3 : Définitions</h1>
      <p>
      ...
      <ol>
        ...
        <li>
          ...
          l'identification d'un Utilisateur sur le site. L'identifiant et le mot de passe permettent
          à l'Utilisateur d'accéder à des services réservés aux membres du site. Le mot de passe est
          confidentiel.
        </li>
      </ol>
...
export function Art4() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 4 : accès aux services</h1>
      ...
      <p>
        Le site met en œuvre tous les moyens mis à sa disposition pour assurer un accès de qualité à
      ...
      <p>
        ...
        réseau ou du serveur n'engage pas la responsabilité de <strong>E-Corp</strong>.
      </p>
...
export function Art5() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 5 : Propriété intellectuelle</h1>
      ...
      <p>
        ...
        ou modifié par le site. L'Utilisateur ne reçoit aucune justification et notification
...
export function Art6() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 6 : Données personnelles</h1>

      <p>
        Les informations demandées à l’inscription au site sont nécessaires et obligatoires pour la
        création du compte de l'Utilisateur. En particulier, l'adresse électronique pourra être
      ...
      <ol>
        ...
        <li>par voie postale au [adresse]</li>
      </ol>
...
export function Art7() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 7 : Responsabilité et force majeure</h1>

      <p>
        Les sources des informations diffusées sur le site sont réputées fiables. Toutefois, le site
        se réserve la faculté d'une non-garantie de la fiabilité des sources. Les informations
        données sur le site le sont à titre purement informatif. Ainsi, l'Utilisateur assume seul
      ...
      <p>
        Tout usage du service par l'Utilisateur ayant directement ou indirectement pour conséquence
        des dommages doit faire l'objet d'une indemnisation au profit du site.
      </p>

      <p>
        Une garantie optimale de la sécurité et de la confidentialité des données transmises n'est
        pas assurée par le site. Toutefois, le site s'engage à mettre en œuvre tous les moyens
        nécessaires afin de garantir au mieux la sécurité et la confidentialité des données.
      </p>
...
export function Art8() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 8 : Liens hypertextes</h1>

      <p>
        De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où
        mènent ces liens n'engagent en rien la responsabilité de [Nom du site] qui n'a pas le
        contrôle de ces liens.
      </p>

      <p>
        L'Utilisateur s'interdit donc à engager la responsabilité du site concernant le contenu et
        les ressources relatives à ces liens hypertextes sortants.
      </p>
...
export function Art9() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 9 : Évolution du contrat</h1>
...
export function Art10() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 10 : Durée</h1>
...
export function Art11() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 11 : Droit applicable et juridiction compétente</h1>

      <p>
        La législation française s'applique au présent contrat. En cas d'absence de résolution
        amiable d'un litige né entre les parties, seuls les tribunaux [du ressort de la Cour d'appel
        de / de la ville de] [Ville] sont compétents.
      </p>
...
export function Art12() {
  return (
    <div>
      <h1 className="cguArticles mb-4">ARTICLE 12 : Publication par l’Utilisateur</h1>

      <p>Le site permet aux membres de publier [des commentaires / des œuvres personnelles].</p>

      <p>
        Dans ses publications, le membre s’engage à respecter les règles de la Netiquette et les
        règles de droit en vigueur.
      </p>

      <p>
        Le site exerce une modération [a priori / a posteriori] sur les publications et se réserve
        le droit de refuser leur mise en ligne, sans avoir à s’en justifier auprès du membre.
      </p>
