...
import { Input1, Input2, Submit } from "./AdminCategoriesAddComponents";

export default class AdminCategoriesAdd extends Component {
  state = {
    ...
    return (
      <div>
        ...
        <div className="container">
          <h1 className="text-center mt-3">Create a new category</h1>
